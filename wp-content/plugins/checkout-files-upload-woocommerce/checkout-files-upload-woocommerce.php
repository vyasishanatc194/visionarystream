...
final class Alg_WC_Checkout_Files_Upload {
	...
	function action_links( $links ) {
		...
		if ( 'checkout-files-upload-woocommerce.php' === basename( __FILE__ ) ) {
			$custom_links[] = '<a target="_blank" href="https://wpcodefactory.com/item/checkout-files-upload-woocommerce-plugin/">' .
	...
	private function includes() {
		...
		require_once( 'includes/admin/class-alg-wc-checkout-files-upload-settings-file.php' );
		$this->settings = array();
		$this->settings['general']  = require_once( 'includes/admin/class-alg-wc-checkout-files-upload-settings-general.php' );
		$this->settings['emails']   = require_once( 'includes/admin/class-alg-wc-checkout-files-upload-settings-emails.php' );
		$this->settings['template'] = require_once( 'includes/admin/class-alg-wc-checkout-files-upload-settings-template.php' );
