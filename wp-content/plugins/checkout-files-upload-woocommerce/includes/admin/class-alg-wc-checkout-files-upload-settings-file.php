...
class Alg_WC_Checkout_Files_Upload_Settings_File extends Alg_WC_Checkout_Files_Upload_Settings_Section {
	 ...
	 * @version 1.3.0
	 * @since   1.3.0
	 * @todo    [later] (feature) products, cats and tags as comma separated ID list (e.g. from WPML)
	 * @todo    [later] (dev) re-do settings as array, i.e. `alg_checkout_files_upload_enabled[{$i}]` etc.
	 */
	function get_settings() {
		...
		$settings = array(
			...
			array(
				...
				'default'  => __( 'UPLOAD A PHOTO OF IT', 'checkout-files-upload-woocommerce' ),
				'type'     => 'textarea',
			),
			array(
