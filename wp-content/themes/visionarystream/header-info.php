...
<div class="header-full">
	...
	<div class="nav-body">
    	<div class="header-cart">
            <div><a href="<?php echo esc_url( home_url( 'buy-glasses-shopping-cart') ); ?>"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/vs-cart.png" alt="Cart" title="Cart"></a></div>
            <p><span><?php echo sprintf ( _n( '%d', '%d', WC()->cart->get_cart_contents_count() ), WC()->cart->get_cart_contents_count() ); ?></span></p>
            <h3>View Your Cart</h3>
        </div>
        <div>
